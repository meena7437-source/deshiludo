    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center p-5">
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-2xl">
        ...
        <input
          ...
          className="w-full mb-4 p-3 rounded-xl bg-zinc-800 border border-zinc-700 outline-none focus:border-yellow-400"
        />
        ...
        <input
          ...
          className="w-full mb-5 p-3 rounded-xl bg-zinc-800 border border-zinc-700 outline-none focus:border-yellow-400"
        />
